...
(define (domain mine-tick-gravity)
  ...
  (:action physics_stone_roll_left
  ...
  (:action physics_stone_roll_right
  ...
  (:action physics_stone_roll_left_simple
  ...
  (:action physics_gem_roll_left_simple
    :parameters (?c ?next ?left ?down_left ?down - real-cell)
    :precondition (and
      (scan-required)
      (scan-at ?c)
  ...
  (:action physics_stone_roll_right_simple
  ...
  (:action physics_gem_roll_right_simple
    :parameters (?c ?next ?left ?right ?down_left ?down ?down_right - real-cell)
    :precondition (and
      (scan-required)
      (scan-at ?c)
